...
public class TestTaskThree extends AbstractTest {
  ...
  @Test
  public void testNoArgConstructorInitializesIdField()
  ...
  @Test
  public void testNoArgConstructorSetsUniqueIds()
    throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchFieldException {
    Class jobClass = getClassByName("Job");
    Constructor<Job> noArgConstructor = jobClass.getConstructor();
  ...
  @Test
  public void testSecondConstructorArguments()
    ...
    try {
      ...
      fail(
        "Job does not have a second constructor with the appropriate arguments"
      );
    }
  }

  @Test
  public void testSecondConstructorInitializesProperties()
    throws ClassNotFoundException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException, NoSuchFieldException {
    Class jobClass = getClassByName("Job");
  ...
  @Test
  public void testSecondConstructorCallsNoArgConstructor(@Mocked Job job)
  ...
  public void testEqualsMethod()
    throws ClassNotFoundException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, InstantiationException, NoSuchFieldException {
    Job job = createJob(
      "Name",
      "Employer",
      "Location",
