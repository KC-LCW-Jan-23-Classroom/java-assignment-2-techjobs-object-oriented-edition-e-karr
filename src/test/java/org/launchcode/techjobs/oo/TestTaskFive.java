...
public class TestTaskFive extends AbstractTest {
  ...
  @Test
  public void testTestToStringStartsAndEndsWithNewLineExists()
    throws ClassNotFoundException {
    Class jobTestClass = getClassByName("test.JobTest");
    Method testToStringStartsAndEndsWithNewLineMethod = null;

    try {
      testToStringStartsAndEndsWithNewLineMethod =
        jobTestClass.getMethod("testToStringStartsAndEndsWithNewLine");
    } catch (NoSuchMethodException e) {
      fail(
        "JobTest does not have a testToStringStartsAndEndsWithNewLine method"
      );
    }
  }
  ...
  public void testTestToStringStartsAndEndsWithNewLineCallsToString(
    ...
    Method testToStringStartsAndEndsWithNewLineMethod = jobTestClass.getMethod(
  ...
  public void testTestToStringContainsCorrectLabelsAndDataExists()
    ...
    try {
      testToStringContainsCorrectLabelsAndDataMethod =
        jobTestClass.getMethod("testToStringContainsCorrectLabelsAndData");
    } catch (NoSuchMethodException e) {
      fail(
        "JobTest does not have a testToStringContainsCorrectLabelsAndData method"
      );
    }
  }
  ...
  public void testTestToStringContainsCorrectLabelsAndDataCallsAssertions(
    ...
    new Expectations() {
      {
        Assert.assertEquals(anyString, anyString);
        minTimes = 1;
      }
    };
  ...
  public void testTestToStringHandlesEmptyFieldExists()
    ...
    try {
      testToStringHandlesEmptyField =
        jobTestClass.getMethod("testToStringHandlesEmptyField");
    } catch (NoSuchMethodException e) {
  ...
  @Test
  public void testTestToStringHandlesEmptyFieldCallsToString(@Mocked Job job)
    throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
    Class jobTestClass = getClassByName("test.JobTest");
    JobTest jobTest = (JobTest) jobTestClass.getConstructor().newInstance();
    Method testToStringHandlesEmptyField = jobTestClass.getMethod(
      "testToStringHandlesEmptyField"
    );
