...
public class TestTaskTwo extends AbstractTest {
  ...
  @Test
  public void testSecondLocationConstructorExists()
    ...
    try {
      ...
      fail(
        "Location does not have a constructor that takes a String parameter"
      );
    }
  }

  @Test
  public void testSecondLocationConstructorInitializesValue()
  ...
  @Test
  public void testSecondLocationConstructorInitializesId()
  ...
  @Test
  public void testCoreCompetencyHasValueAccessors()
    throws ClassNotFoundException {
  ...
  public void testPositionTypeEqualsMethod()
    ...
    try {
      ...
      anotherPositionTypeIdField =
        PositionType.class.getSuperclass().getDeclaredField("id");
    }
  ...
  @Test
  public void testPositionTypeHashCodeMethod()
    ...
    assertEquals(
      hashCodeMethod.invoke(positionType),
      hashCodeMethod.invoke(positionType)
    );
    assertNotEquals(
      hashCodeMethod.invoke(positionType),
      hashCodeMethod.invoke(anotherPositionType)
    );
