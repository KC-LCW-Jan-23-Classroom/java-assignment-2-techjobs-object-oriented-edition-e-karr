...
public class TestTaskFour extends AbstractTest {
  ...
  @Test
  public void testTestSettingJobIdCallsJobConstructorTwice(@Mocked Job job)
  ...
  @Test
  public void testTestJobConstructorSetsAllFieldsExists()
    throws ClassNotFoundException {
    Class jobTestClass = getClassByName("test.JobTest");
    Method testSettingJobIdMethod = null;

    try {
      testSettingJobIdMethod =
  ...
  @Test
  public void testTestJobConstructorSetsAllFieldsCallsAsserts(
    @Mocked Assert mockedAssert
  )
    throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    Class jobTestClass = getClassByName("test.JobTest");
    Method testJobConstructorSetsAllFieldsMethod = jobTestClass.getMethod(
      "testJobConstructorSetsAllFields"
    );

    new Expectations() {
      {
        Assert.assertTrue(anyBoolean);
        minTimes = 5;
  ...
  @Test
  public void testTestJobsForEqualityCallsAssertion(
    @Mocked Assert mockedAssert
  )
    throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    Class jobTestClass = getClassByName("test.JobTest");
    Method testJobsForEqualityMethod = jobTestClass.getMethod(
      "testJobsForEquality"
    );
